                    ...
                    <table id="datatable">
                        ...
                        @forelse ($products as $index => $product)
                            <tr>
                                ...
                                <td>
                                    <a href="" class="btn btn-info btn-sm">Lihat</a> {{--{{ route('activities.show', $product->id) }}--}}
                                    <a href="{{ route('adminproduct.edit', $product->id) }}" class="btn btn-warning btn-sm mt-2">Edit</a>
