    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="{{route('cashier.index')}}">Home</a></li>
                <li class="breadcrumb-item active">Transaksi</li>
            </ol>
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-flex justify-content-start mb-4">
                        <a href="{{ route('cashiertransaction.create') }}" class="btn btn-primary m-3">+ Pembelian Baru</a>
                        <a href="{{ route('cashiertransaction.export-excel')}}" class="btn btn-primary m-3">Export Data (excel)</a>
                    </div>
                    @if (session('success'))
                    ...
                    <tbody>
                        ...
                        @foreach ($transactions as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('cashiertransaction.downloadStruk', $item['id']) }}" class="btn btn-secondary">Download Setruk</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
