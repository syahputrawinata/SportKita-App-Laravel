...
class TransactionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('cashier.transaction.create', compact('products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($transactions) {
            return redirect()->route('cashiertransaction.showStruk', ['id' => $transactions->id])
    ...
    public function showStruk(string $id)
    {
        ...
        return view('cashier.transaction.struk', compact('transactions'));
    }
    ...
    public function downloadStruk($id) 
    {
        ...
        $pdf = PDF::loadView('cashier.transaction.Download-pdf', $transactions);
    ...
    {
        return Excel::download(new TransactionsExport, 'rekap-penjualan.xlsx');
    }
